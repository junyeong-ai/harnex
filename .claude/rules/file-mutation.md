...
- `write_atomic` ([file: crates/harness-core/src/path_guard.rs :: pub fn write_atomic]) — full-file
  replace via same-directory temp file + rename.
- `append_line` ([file: crates/harness-core/src/path_guard.rs :: pub fn append_line]) — append-only
