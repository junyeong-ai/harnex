...
Python/uv, …), composes the safety-critical pieces from `templates/`, and
...
the plugin generates the project-native wiring that uses them. Project-
...
belong with the project's domain knowledge, not with harnex.
