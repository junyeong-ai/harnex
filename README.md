...
Project-native harness scaffolding (hooks, settings, CLAUDE.md, rules,
in the project's own language) is generated by the harnex plugin's
skill — the `harness` binary is the spec-correct reference oracle.
